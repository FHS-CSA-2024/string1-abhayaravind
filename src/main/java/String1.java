...
public class String1
{
    ...
    public String makeOutWord(String out, String word) {
        int x  = out.length()/2;
        return out.substring(0,x) + word + out.substring(x);
    }

    /*
     * Given a string, return a new string made of 3 copies of the last 2 characters of the original string. 
    ...
    public String conCat(String a, String b) {
        int x = a.length();
        if (b.length() > 0 && a.substring(x-1).equals(b.substring(0,1))){
            return a.substring(0,x-1) + b;
        }
         else {
            return a+b;
        }
    ...
    public String withoutX(String str) {
        int x = str.length();
         if (str.substring(0,1).equals("x") && str.substring(x-1).equals("x")){
            return str.substring(1, x-1);
        }
        else if (str.substring(0,1).equals("x")){
            return str.substring(1);
        }
        else if (str.substring(x-1).equals("x")){
